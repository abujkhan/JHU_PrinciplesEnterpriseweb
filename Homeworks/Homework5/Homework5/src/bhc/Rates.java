...
//        System.out.println("normal days = " + normalDays + ", premium days = " + premiumDays);
    ...
    public void setEndDate(int duration){
       //day = beginDate.getDayOfMonth();
       GregorianCalendar day = beginDate.getDate();
       day.add(Calendar.DAY_OF_MONTH, duration);
       endDate = new BookingDay(Calendar.YEAR,Calendar.MONTH, Calendar.DAY_OF_MONTH);
       
    }

    /** Quick test of the class */
 //   public static void main(String[] argv) {
//        BookingDay startDay = new BookingDay(2010,6,1);
//        BookingDay endDay = new BookingDay(2010,6, 8);
