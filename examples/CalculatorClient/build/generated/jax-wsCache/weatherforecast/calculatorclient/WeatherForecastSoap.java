...
public interface WeatherForecastSoap {
     ...
     * @param zipCode
     * @return
     *     returns calculatorclient.WeatherForecasts
     */
    ...
    @RequestWrapper(localName = "GetWeatherByZipCode", targetNamespace = "http://www.webservicex.net", className = "calculatorclient.GetWeatherByZipCode")
    @ResponseWrapper(localName = "GetWeatherByZipCodeResponse", targetNamespace = "http://www.webservicex.net", className = "calculatorclient.GetWeatherByZipCodeResponse")
    ...
    @RequestWrapper(localName = "GetWeatherByPlaceName", targetNamespace = "http://www.webservicex.net", className = "calculatorclient.GetWeatherByPlaceName")
    @ResponseWrapper(localName = "GetWeatherByPlaceNameResponse", targetNamespace = "http://www.webservicex.net", className = "calculatorclient.GetWeatherByPlaceNameResponse")
